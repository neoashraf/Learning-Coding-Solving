...
int main() {
    int n,input[1005],track[1005][2],a,b,i,cnt;
    ...
    nfr(i,0,n){
        if(ab[i].first == ab[i].second){
            if(track[ab[i].second][1] == 0){
                if(track[ab[i].second][0] > 1){
                    cnt -= (track[ab[i].second][0]-1);
                    track[ab[i].second][0] = 1;
                    track[ab[i].second][1] = 1;
                }
            }
            else{
                cnt -= track[ab[i].second][0];
                track[ab[i].second][0] = 0;
            }
        }
        else{
            cnt -= track[ab[i].second][0];
